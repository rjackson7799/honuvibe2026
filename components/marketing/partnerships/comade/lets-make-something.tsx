...
export function ComadeLetsMakeSomething() {
  const t = useTranslations('partnerships.comade.lets_make_something');
    ...
    <Section variant="navy" spacing="default">
      <Container>
        ...
        <div className="grid gap-12 md:grid-cols-[1.2fr_1fr] md:items-end md:gap-16">
          <h2
            className="font-serif italic leading-[1] tracking-[-0.02em] text-white"
