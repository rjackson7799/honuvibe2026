...
export function ExploreNextIssue() {
  ...
  return (
    <Section variant="navy" spacing="default">
      <Container>
        {/* End-of-issue meta strip */}
        <div className="mb-12 flex flex-wrap items-center justify-between gap-4 border-y border-white/10 py-3 font-mono text-[10.5px] uppercase tracking-[0.18em] text-white/60">
