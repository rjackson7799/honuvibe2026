...
const steps = [
  { num: '01', Icon: Search, color: 'var(--accent-teal)', hex: '#459b98' },
  { num: '02', Icon: PenTool, color: 'var(--accent-gold)', hex: '#c59a3f' },
  { num: '03', Icon: Code, color: 'var(--territory-db)', hex: '#5a7bb0' },
  { num: '04', Icon: Rocket, color: 'var(--territory-auto)', hex: '#8974a9' },
  { num: '05', Icon: TrendingUp, color: 'var(--territory-pro)', hex: '#4d9d74' },
] as const;
        ...
        <div className="hidden lg:block">
          <div className="relative">
            ...
            <motion.div
              ...
              viewport={{ once: true, margin: '-50px' }}
            >
              {steps.map(({ num, Icon, color, hex }, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Step number */}
                    <motion.span
                      className="mb-1.5 font-mono text-sm font-semibold tracking-widest"
                      style={{ color }}
                      animate={
                        !prefersReducedMotion
