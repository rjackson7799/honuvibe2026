...
export function PartnerNav({ partnerName, partnerLogoUrl, previewMode }: Props) {
        ...
        <div className="mb-6 px-1">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="truncate text-sm font-semibold text-fg-primary">{partnerName}</h2>
              <p className="text-[11px] uppercase tracking-wider text-fg-tertiary">Partner portal</p>
            </div>
          </div>
          {previewMode && (
            <div className="mt-2 inline-flex items-center gap-1 rounded bg-accent-gold/10 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider text-accent-gold">
              <Eye size={11} /> Admin preview
            </div>
          )}
        </div>
